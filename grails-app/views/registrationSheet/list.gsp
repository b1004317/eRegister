			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="studentSignature" title="${message(code: 'registrationSheet.studentSignature.label', default: 'Student Signature')}" />
				...
				<g:each in="${registrationSheetInstanceList}" status="i" var="registrationSheetInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: registrationSheetInstance, field: "studentSignature")}</td>
