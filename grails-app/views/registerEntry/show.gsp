		...
		<div id="show-registerEntry" class="content scaffold-show" role="main">
			...
			<ol class="property-list registerEntry">
				...
				<li class="fieldcontain">
					<span id="class_registrationsheet-label" class="property-label"><g:message code="registerEntry.class_registrationsheet.label" default="Classregistrationsheet" /></span>
