	...
	<body>
		...
		<div id="show-student" class="content scaffold-show" role="main">
			...
			<ol class="property-list student">
				...
				<g:if test="${studentInstance?.classes_has_many_registerentries}">
				<li class="fieldcontain">
					<span id="classes_has_many_registerentries-label" class="property-label"><g:message code="student.classes_has_many_registerentries.label" default="Classeshasmanyregisterentries" /></span>
					
						<g:each in="${studentInstance.classes_has_many_registerentries}" var="c">
						<span class="property-value" aria-labelledby="classes_has_many_registerentries-label"><g:link controller="registerEntry" action="show" id="${c.id}">${c?.encodeAsHTML()}</g:link></span>
						</g:each>
