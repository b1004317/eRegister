	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<g:if test="${courseInstance?.classes_no_of_Regclass_on_course}">
				<li class="fieldcontain">
					<span id="classes_no_of_Regclass_on_course-label" class="property-label"><g:message code="course.classes_no_of_Regclass_on_course.label" default="Classesnoof Regclassoncourse" /></span>
					
						<g:each in="${courseInstance.classes_no_of_Regclass_on_course}" var="c">
						<span class="property-value" aria-labelledby="classes_no_of_Regclass_on_course-label"><g:link controller="regClass" action="show" id="${c.id}">${c?.encodeAsHTML()}</g:link></span>
						</g:each>
