...
<div class="fieldcontain ${hasErrors(bean: regClassInstance, field: 'classes_registrationsheets', 'error')} ">
	<label for="classes_registrationsheets">
		<g:message code="regClass.classes_registrationsheets.label" default="Classesregistrationsheets" />
